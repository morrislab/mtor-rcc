...
```{r}
# default oncoplot
try(oncoplot(maf = maf_data, gene_mar = 8, fontSize = 0.6))
```
...
try(onco_p_plot(id, maf_fn, result_fn, pathways[1:pidx,]))
try(onco_p_plot(id, maf_fn, result_fn, pathways[pidx:dim(pathways)[1],]))
